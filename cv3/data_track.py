...
for split in ['train', 'test', 'all', '01', '02', '03', '04', '05', '06', '07', '08', '09',
              ...
              'train_wo_04', 'train_wo_09', 'train_wo_10', 'train_wo_05', 'train_wo_11', 'train_wo_13', 'train_wo_02',
              'train_wo_001', 'train_wo_002', 'train_wo_003', '001', '002', '003', 'val3']:
    name = f'MOT16-{split}'
...
class MOT16(Dataset):
    ...
    def __init__(self, root_dir, split, **kwargs):
        ...
        val_sequences3 = ["MOT16-02", "MOT16-11", 'MOT16-09']
        ...
        if "train" == split:
            ...
            sequences = val_sequences3
        
        elif 'train_wo_04' == split: 
            sequences = ["MOT16-02", "MOT16-13", "MOT16-05", "MOT16-09", "MOT16-11", "MOT16-10"]
        elif 'train_wo_09' == split: 
            sequences = ["MOT16-02", "MOT16-13", "MOT16-05", "MOT16-11", "MOT16-10", "MOT16-04"]
        elif 'train_wo_10' == split: 
            sequences = ["MOT16-02", "MOT16-13", "MOT16-05", "MOT16-09", "MOT16-11", "MOT16-04"]
        elif 'train_wo_05' == split: 
            sequences = ["MOT16-02", "MOT16-13", "MOT16-09", "MOT16-11", "MOT16-10", "MOT16-04"]
        elif 'train_wo_11' == split: 
            sequences = ["MOT16-02", "MOT16-13", "MOT16-05", "MOT16-09", "MOT16-10", "MOT16-04"]
        elif 'train_wo_13' == split: 
            sequences = ["MOT16-02", "MOT16-05", "MOT16-09", "MOT16-11", "MOT16-10", "MOT16-04"]
        elif 'train_wo_02' == split: 
            sequences = ["MOT16-13", "MOT16-05", "MOT16-09", "MOT16-11", "MOT16-10", "MOT16-04"]
        
        elif 'train_wo_001' == split: 
            sequences = ["MOT16-02", "MOT16-13", "MOT16-05", "MOT16-09", "MOT16-11", "MOT16-10", "MOT16-04", "MOT16-002", "MOT16-003"]
        elif 'train_wo_002' == split: 
            sequences = ["MOT16-02", "MOT16-13", "MOT16-05", "MOT16-09", "MOT16-11", "MOT16-10", "MOT16-04", "MOT16-001", "MOT16-003"]
        elif 'train_wo_003' == split: 
            sequences = ["MOT16-02", "MOT16-13", "MOT16-05", "MOT16-09", "MOT16-11", "MOT16-10", "MOT16-04", "MOT16-002", "MOT16-001"]
